...
const protein = [18, 18, 18, 25, 18, 25]
const veggies = [2, 2, 2, 0, 2, 0]
const fat = [0, 0, 0.5, 0, 0.5, 0.5]
const carbs = [0, 15, 35, 0, 40, 35]
const workoutCarbs = [0, 0, 0, 15, 0, 0]

export function getNewModerateAfterThreeTraining(newMealCallback: Function)  {
  const meals = [
    {
      name: 'first',
  ...
  const linkedList = new LinkedList('first cut moderate after three meals')
